...
/// <summary>
/// PumpStop request.
/// Sends stop request to pump
/// </summary>
public class PumpStop extends BaseHTTPRequest<Boolean> {
    public static final String REQUEST_NAME = "PumpStop";
    public static final String RESPONSE_NAME = "";
    public static final String KEY = GetKeyStatic(REQUEST_NAME, RESPONSE_NAME);
    private int mPump = 0;

    public PumpStop(int pump) {
