...
import com.technotrade.pts2.enumeration.StateOnOff;
...
/// Sets lights On/Off
/// </summary>
public class PumpSetLights extends BaseHTTPRequest<Boolean> {
    public static final String REQUEST_NAME = "PumpSetLights";
    ...
    public PumpSetLights(int pump, boolean lightsEnabled) {
        super(REQUEST_NAME, RESPONSE_NAME);

        mPump = pump;
        mLightsEnabled = lightsEnabled;
    }
    ...
    public JSONObject requestJSON() throws TTException, JSONException {
        ...
        requestData.put("State", mLightsEnabled ? StateOnOff.ON.getValue() : StateOnOff.OFF.getValue());
