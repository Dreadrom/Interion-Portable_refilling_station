...
/// </summary>
public class PumpEmergencyStop extends BaseHTTPRequest<Boolean> {
    public static final String REQUEST_NAME = "PumpEmergencyStop";
    public static final String RESPONSE_NAME = "";
    public static final String KEY = GetKeyStatic(REQUEST_NAME, RESPONSE_NAME);
    private int mPump = 0;

    public PumpEmergencyStop(int pump) {
