...
cd Interion-Portable_refilling_station/portable-refill-app
```
...
2. **[TODO.md](../operations/TODO.md)** (10 min read)
...
4. **[ARCHITECTURE.md](../architecture/ARCHITECTURE.md)** (Optional - deep dive)
...
### Checklist
Open [TODO.md](../operations/TODO.md) and find "Phase 1" - that's your checklist! Check off items as you complete them.
...
| I need to... | Look here |
|--------------|-----------|
| See what to build | [TODO.md](../operations/TODO.md) |
...
| Check progress | [TODO.md](../operations/TODO.md) |
| Document work | [PROMPTS.md](../operations/PROMPTS.md) |
